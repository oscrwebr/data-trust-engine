...
def test_get_roles_service(db):
    ...
    repository.update_role_thresholds(
        db,
        role.role_id,
        [{"sensitivity_subcategory_id": sub.sensitivity_subcategory_id, "threshold": 10}]
    )
...
def test_update_role_service(db):
    ...
    service.update_role(
        db,
        role.role_id,
        [{"sensitivity_subcategory_id": sub.sensitivity_subcategory_id, "threshold": 5}]
    )
    ...
    # Update again (should replace previous)
    service.update_role(
        db,
        role.role_id,
        [{"sensitivity_subcategory_id": sub.sensitivity_subcategory_id, "threshold": 99}]
    )
