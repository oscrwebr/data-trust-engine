...
from app.access_mapping.schemas import FileEmployeeAccessResponse, FileRiskDetailsResponse
...
@router.get("/get_highest_risk_files", response_model=list[FileRiskDetailsResponse])
